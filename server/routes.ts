...
import { db } from "./db";
import { insertVideoGenerationSchema, insertUserSchema, type User, type ExternalApiKey, insertRewardClaimSchema, type RewardClaim, insertObjectReplacementSchema, insertPhotaiOperationSchema, type PhotoaiOperation } from "@shared/schema";
import { z } from "zod";
